...
- [ ] Visit the [Posit Connect Cloud documentation](https://docs.posit.co/connect-cloud/). Review deployment requirements and setup instructions. Ensure your application meets the prerequisites.
   - Any `.py` Shiny app needs `requirements.txt`.
   - Any `.R` Shiny app needs `manifest.json`, created with `rsconnect::writeManifest()`.

### 🧱 Stage 2: Deploy Your Application

Follow the documentation to deploy your application to Posit Connect Cloud.
...
To customize your app deployment further, consider these extra tabs in **Settings** for your deployed app.
